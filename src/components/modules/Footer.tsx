...
export const Footer = () => {
  return (
    <footer className="flex w-full justify-center  border-t-4 border-main p-6 font-kiwi ">
      <div className="flex w-full max-w-6xl flex-col items-center justify-around gap-6 md:flex-row md:p-14">
        <div className="flex w-full flex-col gap-16">
          <span className="hidden text-3xl md:flex">
